...
This repository contains samples on how to load images from SD card or Url in carousel control. This app is used to load the images from SD card or URL in SfCarousel.

## Syncfusion Controls

This project uses the following Syncfusion controls:

* [SfCarousel](https://www.syncfusion.com/xamarin-ui-controls/scheduler) - To show the sfcarousel
